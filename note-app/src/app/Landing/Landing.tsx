...
import { Dot, GitHub, LinkedIn, Twitter } from '@/svg/logo'
    ...
    <div className='bg-[#171717] min-h-screen'>
      <div className='pl-8 pr-8 flex justify-between'>
        <div className="animate-slidein300 items-center mt-6">
          <div className='w-10 ml-8 flex'>
            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#000000">
              <g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g>
        ...
        <div className='mt-8 mr-10 '>
          <div className="animate-slidein300">
            <button
              ...
              className="flex font-bold bg-[#7f56d9] text-white md:font-medium tracking-tight rounded-full"
            >
              <span className="p-2 pr-4 pl-4 font-extrabold">
      ...
      <div>
        <div className='flex text-slate-100 mt-[100px] justify-center'>
        ...
        <div className='flex mt-[50px] text-slate-300 justify-center'>
          <Link href="/dashboard/" className="animate-slidein300">
        ...
        <div className='flex justify-center '>
          <Image className="animate-slidein300 p-10" src={lap} alt="" />
        </div>
                ...
                <div className="grid md:grid-cols gap-8 items-center">
                  ...
                  >
                    <div className='flex justify-center mt-8  mb-24 '>
                      <Image className="rounded-xl border-4 border-[#7f56d9]  animate-slidein300 " src={page5} alt="" />
                    </div>
                  </motion.div>
                </div>
              </div>
          ...
          <div className=' mb-16 flex flex-row gap-12'>
            <div className="aspect-square rounded-2xl bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 p-1">
              <div className=" rounded-xl bg-gray-800 p-8">
                <Image className="shadow-xl shadow-amber-500/50 rounded-xl animate-slidein300 " src={page1} alt="" />
                <Image className=" shadow-xl mt-20 shadow-pink-500/50 rounded-xl animate-slidein300 " src={page4} alt="" />
              </div>
            </div>
            <div className="aspect-square rounded-2xl bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 p-1">
              <div className=" rounded-xl bg-gray-800 p-8">
                <Image className="shadow-xl shadow-amber-500/50 rounded-xl animate-slidein300 " src={page2} alt="" />
                <Image className=" shadow-xl mt-20 shadow-pink-500/50 rounded-xl animate-slidein300 " src={page3} alt="" />
              </div>
            </div>
          </div>
        </div>
