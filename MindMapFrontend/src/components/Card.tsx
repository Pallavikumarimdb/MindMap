...
export function Card({ title, link, type, contentId, onDelete }: CardProps) {
  ...
  return <div>
    <div className=" transition-all  duration-300 hover:-translate-y-1 overflow-hidden  rounded-md border-gray-200  text-white border  w-74">
      ...
      <div className="">
        ...
        {type === "general" && <div><previewbox-link href={link} ></previewbox-link></div>}
      </div>
