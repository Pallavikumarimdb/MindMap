                            ...
                            <span className="  bg-white opacity-100 p-6 px-10 rounded fixed">
                                ...
                                <div className="bg-white flex  justify-center">
                                    <div className="text-center rounded-xl border p-8">
                                        <h1 className="text-2xl mb-10 font-bold text-gray-700">Share Your Brain</h1>
                                        <div className="mt-10">
                                        ...
                                        {shareLink && (
                                            <div className=" mt-10 py-4">
                                                <p className="flex bg-gray-400 text-blue-900 rounded-2xl  py-2">
                                                    <button
                                                        onClick={() => {
                                                    ...
                                                    <p className="pr-4 mt-1">{shareLink}</p>
                                                </p>
                                            </div>
                                        )}
                                    </div>
